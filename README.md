...
| 945  | [使数组唯一的最小增量](https://leetcode-cn.com/problems/minimum-increment-to-make-array-unique) | **中等** |
...
| 759  | [员工空闲时间](https://leetcode-cn.com/problems/employee-free-time) | **困难** |
| 767  | [重构字符串](https://leetcode-cn.com/problems/reorganize-string) | **中等** |
...
| 928  | [尽量减少恶意软件的传播 II](https://leetcode-cn.com/problems/minimize-malware-spread-ii) | **困难** |
| 947  | [移除最多的同行或同列石头](https://leetcode-cn.com/problems/most-stones-removed-with-same-row-or-column) | **中等** |
...
| 878  | [第 N 个神奇数字](https://leetcode-cn.com/problems/nth-magical-number) | **困难** |
...
| 927  | [三等分](https://leetcode-cn.com/problems/three-equal-parts) | **困难** |
| 981  | [基于时间的键值存储](https://leetcode-cn.com/problems/time-based-key-value-store) | **中等** |
| 1011 | [在 D 天内送达包裹的能力](https://leetcode-cn.com/problems/capacity-to-ship-packages-within-d-days) | **中等** |
| 1044 | [最长重复子串](https://leetcode-cn.com/problems/longest-duplicate-substring) | **困**   |
...
| 826  | [安排工作以达到最大收益](https://leetcode-cn.com/problems/most-profit-assigning-work) | **中等** |
| 828  | [独特字符串](https://leetcode-cn.com/problems/unique-letter-string) | **困难** |
| 838  | [推多米诺](https://leetcode-cn.com/problems/push-dominoes)   | **中等** |
| 844  | [比较含退格的字符串](https://leetcode-cn.com/problems/backspace-string-compare) | **简单** |
| 845  | [数组中的最长山脉](https://leetcode-cn.com/problems/longest-mountain-in-array) | **中等** |
| 881  | [救生艇](https://leetcode-cn.com/problems/boats-to-save-people) | **中等** |
| 904  | [水果成篮](https://leetcode-cn.com/problems/fruit-into-baskets) | **中等** |
| 923  | [三数之和的多种可能](https://leetcode-cn.com/problems/3sum-with-multiplicity) | **中等** |
| 925  | [长按键入](https://leetcode-cn.com/problems/long-pressed-name) | **简单** |
| 930  | [和相同的二元子数组](https://leetcode-cn.com/problems/binary-subarrays-with-sum) | **中等** |
| 977  | [有序数组的平方](https://leetcode-cn.com/problems/squares-of-a-sorted-array) | **简单** |
...
| 544  | [输出比赛匹配对](https://leetcode-cn.com/problems/output-contest-matches) | **中等** |
| 625  | [最小因式分解](https://leetcode-cn.com/problems/minimum-factorization) | **中等** |
| 687  | [最长同值路径](https://leetcode-cn.com/problems/longest-univalue-path) | **简单** |
| 698  | [划分为k个相等的子集](https://leetcode-cn.com/problems/partition-to-k-equal-sum-subsets) | **中等** |
| 726  | [原子的数量](https://leetcode-cn.com/problems/number-of-atoms) | **困难** |
| 761  | [特殊的二进制序列](https://leetcode-cn.com/problems/special-binary-string) | **困难** |
| 776  | [拆分二叉搜索树](https://leetcode-cn.com/problems/split-bst) | **中等** |
| 779  | [第K个语法符号](https://leetcode-cn.com/problems/k-th-symbol-in-grammar) | **中等** |
| 783  | [二叉搜索树结点最小距离](https://leetcode-cn.com/problems/minimum-distance-between-bst-nodes) | **简单** |
| 794  | [有效的井字游戏](https://leetcode-cn.com/problems/valid-tic-tac-toe-state) | **中等** |
| 894  | [所有可能的满二叉树](https://leetcode-cn.com/problems/all-possible-full-binary-trees) | **中等** |
| 938  | [二叉搜索树的范围和](https://leetcode-cn.com/problems/range-sum-of-bst) | **简单** |
...
| 426  | [将二叉搜索树转化为排序的双向链表](https://leetcode-cn.com/problems/convert-binary-search-tree-to-sorted-doubly-linked-list) | **中等** |
| 903  | [DI 序列的有效排列](https://leetcode-cn.com/problems/valid-permutations-for-di-sequence) | **困难** |
...
| 310  | [最小高度树](https://leetcode-cn.com/problems/minimum-height-trees) | **中等** |
| 317  | [建筑物的最短距离](https://leetcode-cn.com/problems/shortest-distance-from-all-buildings) | **困难** |
| 323  | [无向图中连通分量的数目](https://leetcode-cn.com/problems/number-of-connected-components-in-an-undirected-graph) | **中等** |
| 407  | [接雨水 II](https://leetcode-cn.com/problems/trapping-rain-water-ii) | **困难** |
...
| 429  | [N叉树的层序遍历](https://leetcode-cn.com/problems/n-ary-tree-level-order-traversal) | **简单** |
| 559  | [N叉树的最大深度](https://leetcode-cn.com/problems/maximum-depth-of-n-ary-tree) | **简单** |
| 773  | [滑动谜题](https://leetcode-cn.com/problems/sliding-puzzle)  | **困难** |
| 785  | [判断二分图](https://leetcode-cn.com/problems/is-graph-bipartite) | **中等** |
| 787  | [K 站中转内最便宜的航班](https://leetcode-cn.com/problems/cheapest-flights-within-k-stops) | **中等** |
| 815  | [公交路线](https://leetcode-cn.com/problems/bus-routes)      | **困难** |
| 847  | [访问所有节点的最短路径](https://leetcode-cn.com/problems/shortest-path-visiting-all-nodes) | **困难** |
| 854  | [相似度为 K 的字符串](https://leetcode-cn.com/problems/k-similar-strings) | **困难** |
| 863  | [二叉树中所有距离为 K 的结点](https://leetcode-cn.com/problems/all-nodes-distance-k-in-binary-tree) | **中等** |
| 864  | [获取所有钥匙的最短路径](https://leetcode-cn.com/problems/shortest-path-to-get-all-keys) | **困难** |
| 909  | [蛇梯棋](https://leetcode-cn.com/problems/snakes-and-ladders) | **中等** |
| 913  | [猫和老鼠](https://leetcode-cn.com/problems/cat-and-mouse)   | **困难** |
| 934  | [最短的桥](https://leetcode-cn.com/problems/shortest-bridge) | **中等** |
| 993  | [二叉树的堂兄弟节点](https://leetcode-cn.com/problems/cousins-in-binary-tree) | **简单** |
| 994  | [腐烂的橘子](https://leetcode-cn.com/problems/rotting-oranges) | **简单** |
| 1036 | [逃离大迷宫](https://leetcode-cn.com/problems/escape-a-large-maze) | **困难** |
...
| 737  | [句子相似性 II](https://leetcode-cn.com/problems/sentence-similarity-ii) | **中等** |
| 743  | [网络延迟时间](https://leetcode-cn.com/problems/network-delay-time) | **中等** |
| 749  | [隔离病毒](https://leetcode-cn.com/problems/contain-virus)   | **困难** |
| 753  | [破解保险箱](https://leetcode-cn.com/problems/cracking-the-safe) | **困难** |
| 756  | [金字塔转换矩阵](https://leetcode-cn.com/problems/pyramid-transition-matrix) | **中等** |
| 430  | [扁平化多级双向链表](https://leetcode-cn.com/problems/flatten-a-multilevel-doubly-linked-list) | **中等** |
| 559  | [N叉树的最大深度](https://leetcode-cn.com/problems/maximum-depth-of-n-ary-tree) | **简单** |
| 778  | [水位上升的泳池中游泳](https://leetcode-cn.com/problems/swim-in-rising-water) | **困难** |
| 785  | [判断二分图](https://leetcode-cn.com/problems/is-graph-bipartite) | **中等** |
...
| 839  | [相似字符串组](https://leetcode-cn.com/problems/similar-string-groups) | **困难** |
| 841  | [钥匙和房间](https://leetcode-cn.com/problems/keys-and-rooms) | **中等** |
| 851  | [喧闹和富有](https://leetcode-cn.com/problems/loud-and-rich) | **中等** |
| 863  | [二叉树中所有距离为 K 的结点](https://leetcode-cn.com/problems/all-nodes-distance-k-in-binary-tree) | **中等** |
| 872  | [叶子相似的树](https://leetcode-cn.com/problems/leaf-similar-trees) | **简单** |
| 886  | [可能的二分法](https://leetcode-cn.com/problems/possible-bipartition) | **中等** |
| 897  | [递增顺序查找树](https://leetcode-cn.com/problems/increasing-order-search-tree) | **简单** |
| 924  | [尽量减少恶意软件的传播](https://leetcode-cn.com/problems/minimize-malware-spread) | **困难** |
| 928  | [尽量减少恶意软件的传播 II](https://leetcode-cn.com/problems/minimize-malware-spread-ii) | **困难** |
| 934  | [最短的桥](https://leetcode-cn.com/problems/shortest-bridge) | **中等** |
...
| 971  | [翻转二叉树以匹配先序遍历](https://leetcode-cn.com/problems/flip-binary-tree-to-match-preorder-traversal) | **中等** |
| 979  | [在二叉树中分配硬币](https://leetcode-cn.com/problems/distribute-coins-in-binary-tree) | **中等** |
| 980  | [不同路径 III](https://leetcode-cn.com/problems/unique-paths-iii) | **困难** |
| 988  | [从叶结点开始的最小字符串](https://leetcode-cn.com/problems/smallest-string-starting-from-leaf) | **中等** |
| 1020 | [飞地的数量](https://leetcode-cn.com/problems/number-of-enclaves) | **中等** |
| 1026 | [节点与其祖先之间的最大差值](https://leetcode-cn.com/problems/maximum-difference-between-node-and-ancestor) | **中等** |
| 1028 | [从先序遍历还原二叉树](https://leetcode-cn.com/problems/recover-a-tree-from-preorder-traversal) | **困难** |
| 1034 | [边框着色](https://leetcode-cn.com/problems/coloring-a-border) | **中等** |
...
| 320  | [列举缩写](https://leetcode-cn.com/problems/generalized-abbreviation) | **中等** |
...
| 784  | [字母大小写全排列](https://leetcode-cn.com/problems/letter-case-permutation) | **简单** |
| 842  | [将数组拆分成斐波那契序列](https://leetcode-cn.com/problems/split-array-into-fibonacci-sequence) | **中等** |
| 980  | [不同路径 III](https://leetcode-cn.com/problems/unique-paths-iii) | **困难** |
| 996  | [正方形数组的数目](https://leetcode-cn.com/problems/number-of-squareful-arrays) | **困难** |
...
| 567  | [字符串的排列](https://leetcode-cn.com/problems/permutation-in-string) | **中等** |
| 727  | [最小窗口子序列](https://leetcode-cn.com/problems/minimum-window-subsequence) | **困难** |
| 978  | [最长湍流子数组](https://leetcode-cn.com/problems/longest-turbulent-subarray) | **中等** |
| 992  | [K 个不同整数的子数组](https://leetcode-cn.com/problems/subarrays-with-k-different-integers) | **困难** |
...
| 1040 | [移动石子直到连续 II](https://leetcode-cn.com/problems/moving-stones-until-consecutive-ii) | **中等** |
| 1052 | [爱生气的书店老板](https://leetcode-cn.com/problems/grumpy-bookstore-owner) | **中等** |
...
| 659  | [分割数组为连续子序列](https://leetcode-cn.com/problems/split-array-into-consecutive-subsequences) | **中等** |
| 714  | [买卖股票的最佳时机含手续费](https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee) | **中等** |
| 738  | [单调递增的数字](https://leetcode-cn.com/problems/monotone-increasing-digits) | **中等** |
| 757  | [设置交集大小至少为2](https://leetcode-cn.com/problems/set-intersection-size-at-least-two) | **困难** |
| 759  | [员工空闲时间](https://leetcode-cn.com/problems/employee-free-time) | **困难** |
| 763  | [划分字母区间](https://leetcode-cn.com/problems/partition-labels) | **中等** |
| 765  | [情侣牵手](https://leetcode-cn.com/problems/couples-holding-hands) | **困难** |
| 767  | [重构字符串](https://leetcode-cn.com/problems/reorganize-string) | **中等** |
...
| 861  | [翻转矩阵后的得分](https://leetcode-cn.com/problems/score-after-flipping-matrix) | **中等** |
| 870  | [优势洗牌](https://leetcode-cn.com/problems/advantage-shuffle) | **中等** |
| 874  | [模拟行走机器人](https://leetcode-cn.com/problems/walking-robot-simulation) | **简单** |
| 881  | [救生艇](https://leetcode-cn.com/problems/boats-to-save-people) | **中等** |
| 910  | [最小差值 II](https://leetcode-cn.com/problems/smallest-range-ii) | **中等** |
| 921  | [使括号有效的最少添加](https://leetcode-cn.com/problems/minimum-add-to-make-parentheses-valid) | **中等** |
| 927  | [三等分](https://leetcode-cn.com/problems/three-equal-parts) | **困难** |
| 936  | [戳印序列](https://leetcode-cn.com/problems/stamping-the-sequence) | **困难** |
| 944  | [删列造序](https://leetcode-cn.com/problems/delete-columns-to-make-sorted) | **简单** |
| 948  | [令牌放置](https://leetcode-cn.com/problems/bag-of-tokens)   | **中等** |
| 955  | [删列造序 II](https://leetcode-cn.com/problems/delete-columns-to-make-sorted-ii) | **中等** |
| 984  | [不含 AAA 或 BBB 的字符串](https://leetcode-cn.com/problems/string-without-aaa-or-bbb) | **中等** |
| 991  | [坏了的计算器](https://leetcode-cn.com/problems/broken-calculator) | **中等** |
| 995  | [K 连续位的最小翻转次数](https://leetcode-cn.com/problems/minimum-number-of-k-consecutive-bit-flips) | **困难** |
| 1005 | [K 次取反后最大化的数组和](https://leetcode-cn.com/problems/maximize-sum-of-array-after-k-negations) | **简单** |
| 1007 | [行相等的最少多米诺旋转](https://leetcode-cn.com/problems/minimum-domino-rotations-for-equal-row) | **中等** |
| 1029 | [两地调度](https://leetcode-cn.com/problems/two-city-scheduling) | **简单** |
...
| 418  | [屏幕可显示句子的数量](https://leetcode-cn.com/problems/sentence-screen-fitting) | **中等** |
...
| 727  | [最小窗口子序列](https://leetcode-cn.com/problems/minimum-window-subsequence) | **困难** |
| 730  | [统计不同回文子字符串](https://leetcode-cn.com/problems/count-different-palindromic-subsequences) | **困难** |
| 740  | [删除与获得点数](https://leetcode-cn.com/problems/delete-and-earn) | **中等** |
| 741  | [摘樱桃](https://leetcode-cn.com/problems/cherry-pickup)     | **困难** |
| 746  | [使用最小花费爬楼梯](https://leetcode-cn.com/problems/min-cost-climbing-stairs) | **简单** |
| 750  | [角矩形的数量](https://leetcode-cn.com/problems/number-of-corner-rectangles) | **中等** |
| 764  | [最大加号标志](https://leetcode-cn.com/problems/largest-plus-sign) | **中等** |
| 787  | [K 站中转内最便宜的航班](https://leetcode-cn.com/problems/cheapest-flights-within-k-stops) | **中等** |
| 790  | [多米诺和托米诺平铺](https://leetcode-cn.com/problems/domino-and-tromino-tiling) | **中等** |
| 801  | [使序列递增的最小交换次数](https://leetcode-cn.com/problems/minimum-swaps-to-make-sequences-increasing) | **中等** |
| 808  | [分汤](https://leetcode-cn.com/problems/soup-servings)       | **中等** |
| 813  | [最大平均值和的分组](https://leetcode-cn.com/problems/largest-sum-of-averages) | **中等** |
| 818  | [赛车](https://leetcode-cn.com/problems/race-car)            | **困难** |
| 837  | [新21点](https://leetcode-cn.com/problems/new-21-game)       | **中等** |
| 838  | [推多米诺](https://leetcode-cn.com/problems/push-dominoes)   | **中等** |
| 847  | [访问所有节点的最短路径](https://leetcode-cn.com/problems/shortest-path-visiting-all-nodes) | **困难** |
| 871  | [最低加油次数](https://leetcode-cn.com/problems/minimum-number-of-refueling-stops) | **困难** |
| 873  | [最长的斐波那契子序列的长度](https://leetcode-cn.com/problems/length-of-longest-fibonacci-subsequence) | **中等** |
| 877  | [石子游戏](https://leetcode-cn.com/problems/stone-game)      | **中等** |
| 879  | [盈利计划](https://leetcode-cn.com/problems/profitable-schemes) | **困难** |
| 887  | [鸡蛋掉落](https://leetcode-cn.com/problems/super-egg-drop)  | **困难** |
| 898  | [子数组按位或操作](https://leetcode-cn.com/problems/bitwise-ors-of-subarrays) | **中等** |
| 902  | [最大为 N 的数字组合](https://leetcode-cn.com/problems/numbers-at-most-n-given-digit-set) | **困难** |
| 903  | [DI 序列的有效排列](https://leetcode-cn.com/problems/valid-permutations-for-di-sequence) | **困难** |
| 920  | [播放列表的数量](https://leetcode-cn.com/problems/number-of-music-playlists) | **困难** |
| 931  | [下降路径最小和](https://leetcode-cn.com/problems/minimum-falling-path-sum) | **中等** |
| 935  | [骑士拨号器](https://leetcode-cn.com/problems/knight-dialer) | **中等** |
| 940  | [不同的子序列 II](https://leetcode-cn.com/problems/distinct-subsequences-ii) | **困难** |
| 943  | [最短超级串](https://leetcode-cn.com/problems/find-the-shortest-superstring) | **困难** |
| 956  | [最高的广告牌](https://leetcode-cn.com/problems/tallest-billboard) | **困难** |
| 960  | [删列造序 III](https://leetcode-cn.com/problems/delete-columns-to-make-sorted-iii) | **困难** |
| 964  | [表示数字的最少运算符](https://leetcode-cn.com/problems/least-operators-to-express-number) | **困难** |
| 967  | [连续差相同的数字](https://leetcode-cn.com/problems/numbers-with-same-consecutive-differences) | **中等** |
| 968  | [监控二叉树](https://leetcode-cn.com/problems/binary-tree-cameras) | **困难** |
| 975  | [奇偶跳](https://leetcode-cn.com/problems/odd-even-jump)     | **困难** |
| 978  | [最长湍流子数组](https://leetcode-cn.com/problems/longest-turbulent-subarray) | **中等** |
| 982  | [按位与为零的三元组](https://leetcode-cn.com/problems/triples-with-bitwise-and-equal-to-zero) | **困难** |
| 983  | [最低票价](https://leetcode-cn.com/problems/minimum-cost-for-tickets) | **中等** |
| 1000 | [合并石头的最低成本](https://leetcode-cn.com/problems/minimum-cost-to-merge-stones) | **困难** |
| 1012 | [至少有 1 位重复的数字](https://leetcode-cn.com/problems/numbers-with-repeated-digits) | **困难** |
| 1024 | [视频拼接](https://leetcode-cn.com/problems/video-stitching) | **中等** |
| 1025 | [除数博弈](https://leetcode-cn.com/problems/divisor-game)    | **简单** |
| 1027 | [最长等差数列](https://leetcode-cn.com/problems/longest-arithmetic-sequence) | **中等** |
| 1039 | [多边形三角剖分的最低得分](https://leetcode-cn.com/problems/minimum-score-triangulation-of-polygon) | **中等** |
| 1048 | [最长字符串链](https://leetcode-cn.com/problems/longest-string-chain) | **中等** |
...
| 751  | [IP 到 CIDR](https://leetcode-cn.com/problems/ip-to-cidr)    | **简单** |
| 756  | [金字塔转换矩阵](https://leetcode-cn.com/problems/pyramid-transition-matrix) | **中等** |
...
| 753  | [破解保险箱](https://leetcode-cn.com/problems/cracking-the-safe) | **困难** |
| 754  | [到达终点数字](https://leetcode-cn.com/problems/reach-a-number) | **简单** |
| 775  | [全局倒置与局部倒置](https://leetcode-cn.com/problems/global-and-local-inversions) | **中等** |
| 780  | [到达终点](https://leetcode-cn.com/problems/reaching-points) | **困难** |
| 781  | [森林中的兔子](https://leetcode-cn.com/problems/rabbits-in-forest) | **中等** |
| 782  | [变为棋盘](https://leetcode-cn.com/problems/transform-to-chessboard) | **困难** |
| 789  | [逃脱阻碍者](https://leetcode-cn.com/problems/escape-the-ghosts) | **中等** |
| 794  | [有效的井字游戏](https://leetcode-cn.com/problems/valid-tic-tac-toe-state) | **中等** |
| 800  | [相似 RGB 颜色](https://leetcode-cn.com/problems/similar-rgb-color) | **简单** |
| 805  | [数组的均值分割](https://leetcode-cn.com/problems/split-array-with-same-average) | **困难** |
| 810  | [黑板异或游戏](https://leetcode-cn.com/problems/chalkboard-xor-game) | **困难** |
| 812  | [最大三角形面积](https://leetcode-cn.com/problems/largest-triangle-area) | **简单** |
| 829  | [连续整数求和](https://leetcode-cn.com/problems/consecutive-numbers-sum) | **困难** |
| 836  | [矩形重叠](https://leetcode-cn.com/problems/rectangle-overlap) | **简单** |
| 858  | [镜面反射](https://leetcode-cn.com/problems/mirror-reflection) | **中等** |
| 866  | [回文素数](https://leetcode-cn.com/problems/prime-palindrome) | **中等** |
...
| 885  | [螺旋矩阵 III](https://leetcode-cn.com/problems/spiral-matrix-iii) | **中等** |
| 887  | [鸡蛋掉落](https://leetcode-cn.com/problems/super-egg-drop)  | **困难** |
| 891  | [子序列宽度之和](https://leetcode-cn.com/problems/sum-of-subsequence-widths) | **困难** |
| 892  | [三维形体的表面积](https://leetcode-cn.com/problems/surface-area-of-3d-shapes) | **简单** |
| 899  | [有序队列](https://leetcode-cn.com/problems/orderly-queue)   | **困难** |
| 902  | [最大为 N 的数字组合](https://leetcode-cn.com/problems/numbers-at-most-n-given-digit-set) | **困难** |
| 906  | [超级回文数](https://leetcode-cn.com/problems/super-palindromes) | **困难** |
| 908  | [最小差值 I](https://leetcode-cn.com/problems/smallest-range-i) | **简单** |
| 910  | [最小差值 II](https://leetcode-cn.com/problems/smallest-range-ii) | **中等** |
| 914  | [卡牌分组](https://leetcode-cn.com/problems/x-of-a-kind-in-a-deck-of-cards) | **简单** |
| 927  | [三等分](https://leetcode-cn.com/problems/three-equal-parts) | **困难** |
| 942  | [增减字符串匹配](https://leetcode-cn.com/problems/di-string-match) | **简单** |
| 949  | [给定数字能组成的最大时间](https://leetcode-cn.com/problems/largest-time-for-given-digits) | **简单** |
| 952  | [按公因数计算最大组件大小](https://leetcode-cn.com/problems/largest-component-size-by-common-factor) | **困难** |
| 963  | [最小面积矩形 II](https://leetcode-cn.com/problems/minimum-area-rectangle-ii) | **中等** |
| 964  | [表示数字的最少运算符](https://leetcode-cn.com/problems/least-operators-to-express-number) | **困难** |
| 970  | [强整数](https://leetcode-cn.com/problems/powerful-integers) | **简单** |
| 972  | [相等的有理数](https://leetcode-cn.com/problems/equal-rational-numbers) | **困难** |
| 976  | [三角形的最大周长](https://leetcode-cn.com/problems/largest-perimeter-triangle) | **简单** |
| 991  | [坏了的计算器](https://leetcode-cn.com/problems/broken-calculator) | **中等** |
| 996  | [正方形数组的数目](https://leetcode-cn.com/problems/number-of-squareful-arrays) | **困难** |
| 1006 | [笨阶乘](https://leetcode-cn.com/problems/clumsy-factorial)  | **中等** |
| 1009 | [十进制整数的反码](https://leetcode-cn.com/problems/complement-of-base-10-integer) | **简单** |
| 1012 | [至少有 1 位重复的数字](https://leetcode-cn.com/problems/numbers-with-repeated-digits) | **困难** |
| 1015 | [可被 K 整除的最小整数](https://leetcode-cn.com/problems/smallest-integer-divisible-by-k) | **中等** |
| 1017 | [负二进制转换](https://leetcode-cn.com/problems/convert-to-base-2) | **中等** |
| 1025 | [除数博弈](https://leetcode-cn.com/problems/divisor-game)    | **简单** |
| 1037 | [有效的回旋镖](https://leetcode-cn.com/problems/valid-boomerang) | **简单** |
| 1041 | [困于环中的机器人](https://leetcode-cn.com/problems/robot-bounded-in-circle) | **简单** |
...
| 355  | [设计推特](https://leetcode-cn.com/problems/design-twitter)  | **中等** |
| 359  | [日志速率限制器](https://leetcode-cn.com/problems/logger-rate-limiter) | **简单** |
| 362  | [敲击计数器](https://leetcode-cn.com/problems/design-hit-counter) | **中等** |
| 379  | [电话目录](https://leetcode-cn.com/problems/design-phone-directory) | **中等** |
| 380  | [常数时间插入、删除和获取随机元素](https://leetcode-cn.com/problems/insert-delete-getrandom-o1) | **中等** |
| 381  | [O(1) 时间插入、删除和获取随机元素 - 允许重复](https://leetcode-cn.com/problems/insert-delete-getrandom-o1-duplicates-allowed) | **困难** |
...
| 588  | [设计内存文件系统](https://leetcode-cn.com/problems/design-in-memory-file-system) | **困难** |
